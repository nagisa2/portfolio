    ...
    <div class="contact-wrapper">
      ...
      <div class="contact-info">
        ...
        <div class="contact-link">
          <div class="circle-link" @click="whatsapp()">
            <div class="whatsapp">
              <svg class="icon h-icon" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
          ...
          <div class="circle-link" @click="github()">
            <div class="github">
              <svg class="icon h-icon" viewBox="0 0 24 24">
                <path
                  fill="currentColor"
          ...
          <div class="circle-link" @click="behance()">
            <div class="behance">
              <svg class="icon h-icon" viewBox="0 0 16 16">
                <path
                  fill="currentColor"
